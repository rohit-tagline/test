...
const Custombtn=({color,btntitle,...props})=>{
  return(
    <View>
      <Text>{btntitle}</Text>
      <Button color={color} title={props.title} onPress={props.onpress} />
    </View>
  )
}
...
const MapboxScreen = () => {
  return (
    <View style={{flex:1,justifyContent:'center',gap:10}}>
      ...
      <Custombtn btntitle="press 1" color="blue" title="Test Button 1" onpress={()=>Alert.alert("btn 1", "This is button 1")} />
      <Custombtn btntitle="press 2" color="green" title="Test Button 2" onpress={()=> Alert.alert("btn 2", "This is button 2")} />
    </View>
  )
}
